...
void lucia_print_size_checks(void);
...
LUCIA_STATIC_ASSERT(sizeof(CBool) == 1, "Size of CBool was expected to be 1");
LUCIA_STATIC_ASSERT(alignof(CBool) == 1, "Alignment of CBool was expected to be 1");
LUCIA_STATIC_ASSERT(sizeof(LuciaValueType) == 1, "Size of LuciaValueType was expected to be 1");
LUCIA_STATIC_ASSERT(alignof(LuciaValueType) == 1, "Alignment of LuciaValueType was expected to be 1");
LUCIA_STATIC_ASSERT(sizeof(LuciaResultTag) == 1, "Size of LuciaResultTag was expected to be 1");
LUCIA_STATIC_ASSERT(alignof(LuciaResultTag) == 1, "Alignment of LuciaResultTag was expected to be 1");
LUCIA_STATIC_ASSERT(sizeof(ValueData) == 8, "Size of ValueData was expected to be 8");
LUCIA_STATIC_ASSERT(alignof(ValueData) == 8, "Alignment of ValueData was expected to be 8");
LUCIA_STATIC_ASSERT(sizeof(LuciaResultData) == 48, "Size of LuciaResultData was expected to be 48");
LUCIA_STATIC_ASSERT(alignof(LuciaResultData) == 8, "Alignment of LuciaResultData was expected to be 8");
LUCIA_STATIC_ASSERT(sizeof(BuildInfo) == 88, "Size of BuildInfo was expected to be 88");
LUCIA_STATIC_ASSERT(alignof(BuildInfo) == 8, "Alignment of BuildInfo was expected to be 8");
LUCIA_STATIC_ASSERT(sizeof(LuciaConfig) == 48, "Size of LuciaConfig was expected to be 48");
LUCIA_STATIC_ASSERT(alignof(LuciaConfig) == 8, "Alignment of LuciaConfig was expected to be 8");
LUCIA_STATIC_ASSERT(sizeof(LuciaValue) == 24, "Size of LuciaValue was expected to be 24");
LUCIA_STATIC_ASSERT(alignof(LuciaValue) == 8, "Alignment of LuciaValue was expected to be 8");
LUCIA_STATIC_ASSERT(sizeof(LuciaError) == 48, "Size of LuciaError was expected to be 48");
LUCIA_STATIC_ASSERT(alignof(LuciaError) == 8, "Alignment of LuciaError was expected to be 8");
LUCIA_STATIC_ASSERT(sizeof(LuciaResult) == 56, "Size of LuciaResult was expected to be 56");
LUCIA_STATIC_ASSERT(alignof(LuciaResult) == 8, "Alignment of LuciaResult was expected to be 8");
LUCIA_STATIC_ASSERT(sizeof(ValueAsArgs) == 2, "Size of ValueAsArgs was expected to be 2");
LUCIA_STATIC_ASSERT(alignof(ValueAsArgs) == 1, "Alignment of ValueAsArgs was expected to be 1");
LUCIA_STATIC_ASSERT(sizeof(((ValueData*)0)->int_v) == 8, "ValueData.int_v was expected to be 8");
LUCIA_STATIC_ASSERT(alignof(((ValueData*)0)->int_v) == 8, "ValueData.int_v alignment was expected to be 8");
LUCIA_STATIC_ASSERT(sizeof(((ValueData*)0)->float_v) == 8, "ValueData.float_v was expected to be 8");
LUCIA_STATIC_ASSERT(alignof(((ValueData*)0)->float_v) == 8, "ValueData.float_v alignment was expected to be 8");
LUCIA_STATIC_ASSERT(sizeof(((ValueData*)0)->bool_v) == 1, "ValueData.bool_v was expected to be 1");
...
#endif
LUCIA_STATIC_ASSERT(sizeof(((LuciaResultData*)0)->value) == 24, "LuciaResultData.value was expected to be 24");
LUCIA_STATIC_ASSERT(alignof(((LuciaResultData*)0)->value) == 8, "LuciaResultData.value alignment was expected to be 8");
LUCIA_STATIC_ASSERT(sizeof(((LuciaResultData*)0)->error) == 48, "LuciaResultData.error was expected to be 48");
...
#endif
LUCIA_STATIC_ASSERT(sizeof(((LuciaConfig*)0)->moded) == 1, "LuciaConfig.moded was expected to be 1");
LUCIA_STATIC_ASSERT(alignof(((LuciaConfig*)0)->moded) == 1, "LuciaConfig.moded alignment was expected to be 1");
LUCIA_STATIC_ASSERT(sizeof(((LuciaConfig*)0)->debug) == 1, "LuciaConfig.debug was expected to be 1");
...
#endif
LUCIA_STATIC_ASSERT(sizeof(((LuciaConfig*)0)->supports_color) == 1, "LuciaConfig.supports_color was expected to be 1");
LUCIA_STATIC_ASSERT(alignof(((LuciaConfig*)0)->supports_color) == 1, "LuciaConfig.supports_color alignment was expected to be 1");
LUCIA_STATIC_ASSERT(sizeof(((LuciaConfig*)0)->use_lucia_traceback) == 1, "LuciaConfig.use_lucia_traceback was expected to be 1");
...
LUCIA_STATIC_ASSERT(sizeof(((LuciaConfig*)0)->warnings) == 1, "LuciaConfig.warnings was expected to be 1");
LUCIA_STATIC_ASSERT(alignof(((LuciaConfig*)0)->warnings) == 1, "LuciaConfig.warnings alignment was expected to be 1");
LUCIA_STATIC_ASSERT(sizeof(((LuciaConfig*)0)->allow_fetch) == 1, "LuciaConfig.allow_fetch was expected to be 1");
LUCIA_STATIC_ASSERT(alignof(((LuciaConfig*)0)->allow_fetch) == 1, "LuciaConfig.allow_fetch alignment was expected to be 1");
LUCIA_STATIC_ASSERT(sizeof(((LuciaConfig*)0)->allow_unsafe) == 1, "LuciaConfig.allow_unsafe was expected to be 1");
LUCIA_STATIC_ASSERT(alignof(((LuciaConfig*)0)->allow_unsafe) == 1, "LuciaConfig.allow_unsafe alignment was expected to be 1");
LUCIA_STATIC_ASSERT(sizeof(((LuciaConfig*)0)->allow_inline_config) == 1, "LuciaConfig.allow_inline_config was expected to be 1");
...
LUCIA_STATIC_ASSERT(sizeof(((LuciaConfig*)0)->disable_runtime_type_checking) == 1, "LuciaConfig.disable_runtime_type_checking was expected to be 1");
...
#endif
LUCIA_STATIC_ASSERT(sizeof(((LuciaValue*)0)->tag) == 1, "LuciaValue.tag was expected to be 1");
LUCIA_STATIC_ASSERT(alignof(((LuciaValue*)0)->tag) == 1, "LuciaValue.tag alignment was expected to be 1");
LUCIA_STATIC_ASSERT(sizeof(((LuciaValue*)0)->data) == 8, "LuciaValue.data was expected to be 8");
...
#endif
LUCIA_STATIC_ASSERT(sizeof(((LuciaError*)0)->line_num) == 4, "LuciaError.line_num was expected to be 4");
...
#endif
LUCIA_STATIC_ASSERT(sizeof(((LuciaResult*)0)->tag) == 1, "LuciaResult.tag was expected to be 1");
LUCIA_STATIC_ASSERT(alignof(((LuciaResult*)0)->tag) == 1, "LuciaResult.tag alignment was expected to be 1");
LUCIA_STATIC_ASSERT(sizeof(((LuciaResult*)0)->data) == 48, "LuciaResult.data was expected to be 48");
LUCIA_STATIC_ASSERT(alignof(((LuciaResult*)0)->data) == 8, "LuciaResult.data alignment was expected to be 8");
LUCIA_STATIC_ASSERT(sizeof(((ValueAsArgs*)0)->force) == 1, "ValueAsArgs.force was expected to be 1");
LUCIA_STATIC_ASSERT(alignof(((ValueAsArgs*)0)->force) == 1, "ValueAsArgs.force alignment was expected to be 1");
LUCIA_STATIC_ASSERT(sizeof(((ValueAsArgs*)0)->cast) == 1, "ValueAsArgs.cast was expected to be 1");
