...
use crate::env::libs::elevator::utils::create_utils_map;
...
pub fn register(_config: &Config) -> HashMap<String, Variable> {
    ...
    let terminal_module = Module {
        ...
        properties: create_utils_map(),
        parameters: Vec::new(),
        is_public: true,
        is_static: true,
        is_final: true,
        state: None,
        path: PathBuf::from("elevator/utils"),
    };

    insert_native_var!(map, "utils", Value::Module(terminal_module), "module");
